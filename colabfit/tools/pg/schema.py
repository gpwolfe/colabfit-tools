...
config_schema = Schema(
    ...
    columns=[
        ...
        column("last_modified", "TIMESTAMP", True),
...
dataset_schema = Schema(
    ...
    columns=[
        ...
        column("nproperty_objects", "BIGINT", True),
        column("nsites", "BIGINT", True),
        column("nelements", "INT", True),
        column("elements", "VARCHAR (1000) []", True),
        column("total_elements_ratios", "DOUBLE PRECISION []", True),
        column("nperiodic_dimensions", "INT []", True),
        column("dimension_types", "INT [] []", True),
        column("energy_count", "BIGINT", True),
        column("energy_mean", "DOUBLE PRECISION", True),
        column("energy_variance", "DOUBLE PRECISION", True),
        column("atomization_energy_count", "BIGINT", True),
        column("adsorption_energy_count", "BIGINT", True),
        column("formation_energy_count", "BIGINT", True),
        column("atomic_forces_count", "BIGINT", True),
        column("electronic_band_gap_count", "BIGINT", True),
        column("cauchy_stress_count", "BIGINT", True),
        column("energy_above_hull_count", "BIGINT", True),
        ...
        column("software", "VARCHAR (256) []", True),
        column("date_added_to_colabfit", "TIMESTAMP", True),
        column("date_requested", "TIMESTAMP", True),
    ],
)
